            ...
            try:
                ...
                if selected_index.isdigit():
                    if int(selected_index) in self.buttons.keys():
                        ...
                        if (
                            choice == messages.CREATE_TASK
                            or choice == messages.CREATE_SUBTASK
                        ):
                            ...
                            if (
                                self.selected_task != None
                                and self.selected_task.parent_id is not None
                            ):
                                self.selected_task = self.task_manager.get_task_by_id(
                                    self.selected_task.parent_id
                                )
                            else:
                                self.view = "list"
                                self.selected_task = None
                            ...
                            self.task_manager.delete_subtask(
                                get_task=self.selected_task
                            )
                        ...
                        if (
                            choice == messages.VIEW_TASK
                            or choice == messages.VIEW_SUBTASK
                            or choice == messages.BACK
                        ):
                            pass
                        else:
